...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://server-drop.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      try {
        const response = await fetch("https://server-drop.onrender.com/api/v1/post",{
          method:"POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-2-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex gap-5'>
          <button type="button" onClick={generateImage} className='text-white bg-green-700 w-full font-medium rounded-md text-sm  sm:w-auto px-5 py-2.5 text-center'>
